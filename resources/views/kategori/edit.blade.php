    ...
    <div class="card" style="margin-top: 100px; margin-left: 20px; margin-right: 20px;">
        ...
        <form action="{{ route('kategori.update', $kategori->id) }}" method="POST" enctype="multipart/form-data" role="form">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_kategori" placeholder="Olahraga, Kesehatan, dll" aria-describedby="basic-addon1" name="nama_kategori" value="{{$kategori->nama_kategori}}" required>
            </div>
