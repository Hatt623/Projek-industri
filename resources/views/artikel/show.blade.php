    ...
    <div class="card" style="margin-top: 100px; margin-left: 20px; margin-right: 20px;">
        ...
        <form action="{{ route('artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data" role="form">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_artikel" placeholder="Masukkan judul artikel anda" aria-describedby="basic-addon1" name="nama_artikel" value="{{$artikel->nama_artikel}}" disabled required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-control mb-3" name="kategori_id" id="kategori_id"  disabled required>
